...
def main():
    ...
    data = {'Age ' : age , 'Sex' : sex, 'Chest Pain Type' : chestpaintype, 'Resting Blood Pressure' :  restingbps, 'Cholestrol' : cholestrol, 'Fasting Blood Sugar' : fastingbloodsugar, 'Resting ECG' : restingecg, 'Max Heart Rate' : maxheartrate, 'Exercise Induced Angina' : exerciseangina, 'Old Peak' : oldpeak, 'ST Slope' : STslope}
